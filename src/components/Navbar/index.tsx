...
const Navbar = () => {
	...
	return (
		<div className='bg-main-gray font-normal text-xs lg:text-base xs:font-medium w-4/5 md:w-2/3 mx-auto absolute top-[10%] max-w-[1280px] row-span-1 col-span-5 px-2 lg:px-3 py-2 rounded-full'>
