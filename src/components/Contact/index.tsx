    ...
    <div className="flex flex-col items-center gap-12 w-screen px-4 xs:px-12 pt-20 lg:mt-0">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="sm:text-lg lg:text-xl text-center">
          If you want to hire me, offer to join a cool project, or want to ask
          me anything, hit me up!
        </p>
      </div>
      <div className="flex flex-col sm:flex-row items-center gap-12">
          ...
          <div className="flex flex-col items-left gap-8">
            <div className="flex gap-4 items-center">
              ...
              <div>
                ...
                <p className="md:text-lg text-[#808782]">
                  bar.brodowski@gmail.com
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-center">
        ...
        <div className="flex flex-col items-center gap-4">
          <p className="sm:font-medium font-semibold text-sm md:text-base">
            Feel free to download my CV :)
          </p>
          <a
            href={CV}
            download="BartoszBrodowskiCV"
            target="_blank"
            rel="noreferrer"
          >
            <motion.button
